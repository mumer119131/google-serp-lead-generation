        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-muted-foreground mb-6">
              Advanced SERP scraping technology for high-quality lead generation and data extraction.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">SERP Scraping</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Lead Generation</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Contact Enrichment</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Data Analytics</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">CRM Integration</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-muted pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} SERP Scraper. All rights reserved.
            </p>
